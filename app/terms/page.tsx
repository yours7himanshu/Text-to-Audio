    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="prose prose-lg">
        ...
        <p>
          ...
          individuals. Our service converts written text into spoken audio without storing your content after conversion.
        </p>
        ...
        <p>
          The website and its original content (excluding user-submitted content) remain the property of the service 
          operators. The audio files you generate are yours to use for personal, educational, or accessibility purposes.
        </p>
        
        <h2 className="text-2xl font-semibold mt-6 mb-4">6. Disclaimer</h2>
        <p>
